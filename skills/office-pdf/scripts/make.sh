#!/usr/bin/env bash
# make.sh - office-pdf unified CLI
...
[
  ...
  {"type":"body",    "text":"This document was generated by office-pdf - a skill for creating visually polished PDFs. Every design decision is rooted in the document type and content, not a generic template."},
...
JSON
  ...
  cmd_run \
    --title   "office-pdf demo" \
    --type    "report" \
    --author  "office-pdf skill" \
    --date    "$(date '+%B %Y')" \
