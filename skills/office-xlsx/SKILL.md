---
name: office-xlsx
description: "Read, analyze, create, edit, repair, format, or validate spreadsheet files such as .xlsx, .xlsm, .csv, and .tsv. Use when the user provides a spreadsheet file, asks for native Excel output, needs formulas/pivots/financial-model formatting, or needs format-preserving edits. Do not use for ordinary Markdown tables or quick tabular prose unless spreadsheet file output is required."
license: MIT
metadata:
  version: "1.0"
