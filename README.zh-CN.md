...
- `web-ppt`：浏览器可打开的单文件 HTML 演示，vendored runtime 使用 AGPL-3.0
  协议
...
Vendored skill 内容保留各自上游协议。`web-ppt` 使用 AGPL-3.0 协议，其他
vendored Office Pack skills 使用 MIT 协议；见 [NOTICE](NOTICE)。
